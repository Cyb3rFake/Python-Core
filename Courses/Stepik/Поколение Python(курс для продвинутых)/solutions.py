...
def flint_valley(strings_count,freezer_nums_list):
    ...
    """
    # freezer_nums_list = [str(input()) for i in range(strings_count)]
    # freezer_nums_list = 'osfjwoiergwoignaewpjofwoeijfnwfonewfoignewtowenffnoeiwowjfninoiwfen'
    # freezer_nums_list = 'antoooooooooooooooooooooooooooooooooooooooooooooooooooon'
    # freezer_nums_list = list(map(str,'222anton456 a1n1t1o1n1 0000a0000n00t00000o000000n gylfole richard ant0n'.lower().split()))
    fnd_str = 'anton'
    error_nums_lst = []
    error_nums = 0
    word = ''
    ...
    for num in freezer_nums_list:
        ...
        for i in 'anton':
            if i in num:
                # print(freezer_nums_list[freezer_nums_list.find(i)::])
                word += num[num.find(i):][0]


                if word == fnd_str:
                    error_nums_lst.append(error_nums)
                    word = ''
                    continue
            else:
                word=''
