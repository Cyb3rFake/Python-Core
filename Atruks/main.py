import requests #что делает ключевое слово импорт, что за модуль реквест
import xml.etree.ElementTree as ET #что такое as?
...
partners = []#что означают квадратные скобки
